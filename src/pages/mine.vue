...
<template>
  <view class="bg-base-mine">
    ...
    <view class="mx-[30rpx] mt-[30rpx] flex items-center justify-between gap-[30rpx]">
      <view class="bg-006 flex flex-1 flex-col gap-[20rpx] px-[26rpx] text-[#fff]">
        <view class="mt-[16rpx]">
    ...
    <view class="mx-[30rpx] mt-[30rpx] rounded-[20rpx] bg-[#fff] p-[30rpx]">
      <view class="flex items-center justify-between">
        ...
        <view class="flex items-center" @click="go('/packages/order/index')">
          ...
          <wd-icon name="chevron-right" size="24rpx" color="#ABAEB2" />
        </view>
      </view>
    ...
    <view class="mx-[30rpx] mt-[30rpx] rounded-[20rpx] bg-[#fff] p-[30rpx]">
      ...
      <view class="grid grid-cols-[repeat(4,auto)] grid-rows-[repeat(2,auto)] mt-[50rpx] gap-[50rpx]">
        ...
        <view class="flex flex-col items-center" @click="go('/packages/mine/about')">
          <image src="@img/img-018.png" mode="scaleToFill" class="h-[48rpx] w-[46rpx]" />
          <text class="mt-[10rpx] text-[24rpx] text-[#000000]">
            我的收藏
          </text>
        </view>
...
.bg-006 {
  width: 100%;
  height: 176rpx;
  background-image: url('/static/images/bg-006.png');
  background-repeat: no-repeat;
  background-size: 100% 100%;
}
.bg-007 {
  width: 100%;
  height: 176rpx;
  background-image: url('/static/images/bg-007.png');
  background-repeat: no-repeat;
  background-size: 100% 100%;
}
.bg-base-mine {
