  ...
  <view class="home-container bg-[#FAFAFA]" :style="{ paddingTop: `${safeAreaInsets?.top || 0}px` }">
    ...
    <view class="mx-[30rpx]">
      <image
        src=""
        mode="scaleToFill"
        class="h-[202rpx] w-full rounded-[20rpx] bg-[#eaeaea]"
      />
    </view>
    <!-- 热门功能 -->
    ...
    <view class="mx-[30rpx] mt-[30rpx]">
      <div class="grid grid-flow-col grid-rows-3 gap-[28rpx]">
        <div class="col-span-2 row-span-6 h-[352rpx] flex items-center justify-center rounded-[16rpx] bg-[#eaeaea] text-xl font-bold">
          热门景点
        </div>
    ...
    <view class="mx-[30rpx] mt-[30rpx]">
      <image
        src=""
        mode="scaleToFill"
        class="h-[154rpx] w-full rounded-[20rpx] bg-[#eaeaea]"
      />
    </view>
    ...
    <view class="mx-[30rpx] mt-[30rpx]">
      <div class="grid grid-cols-2 gap-4">
        <div class="overflow-hidden rounded-[20rpx] bg-[#fff]">
          <image mode="aspectFill" class="h-[330rpx] w-full bg-[#eaeaea]" />
    ...
    <view class="travel-recommendation">
      ...
      <view class="flex flex-col gap-[32rpx]">
        <view v-for="(travel, index) in recommendedTravel" :key="travel.id">
            ...
            <view class="travel-card gap-[18rpx] rounded-[20rpx] p-[30rpx]">
              <view class="relative w-[190rpx] overflow-hidden">
                <image
                  src="@img/img-006.png"
                  mode="scaleToFill"
                  class="absolute left-0 top-0 z-1 h-[36rpx] w-[86rpx]"
                />
                <image src="https://picsum.photos/190" mode="aspectFill" class="travel-avatar h-[190rpx] w-full rounded-[20rpx]" />
                <view class="absolute bottom-0 left-0 h-[36rpx] w-full text-center text-[20rpx] text-[#FFFFFF]" style="background: linear-gradient( 268deg, #FF8E99 0%, #FF4D54 100%);border-radius:0 0 20rpx 20rpx;">
                  立享服务
                </view>
              </view>
              <view class="flex flex-col justify-between">
                ...
                <view class="flex items-center justify-between">
                  ...
                  <view class="h-[52rpx] w-[140rpx] rounded-full text-center text-[24rpx] text-[#fff] leading-[52rpx]" style="background: linear-gradient( 90deg, #078DF4 0%, #066BEB 100%);">
                    立即下单
                  </view>
                </view>
              </view>
